...
- 이 주제와 직접 관련된 신뢰 가능한 건강/생활정보 뉴스 기사 3개 이상을 선별해 주세요.
- 제목과 링크만 포함하고, 요약이나 설명은 쓰지 마세요.
- 가능한 한 최신 기사 우선으로 골라 주세요.
- 출처는 하이닥, 코메디닷컴, 경향, 조선일보 건강처럼 신뢰성 있는 매체를 우선해 주세요.
...
- 위치는 본문 마지막, 마지막 소제목 이후 마무리 문단 바로 다음입니다.
- 형식은 반드시 <ul> 안에 <li><a href="URL" target="_blank" rel="noopener noreferrer">기사 제목</a></li> 구조를 사용해 주세요.
- 이 사건과 직접 관련된 신뢰 가능한 기사 또는 참고 자료 3개 이상을 선별해 주세요.
- 제목과 링크만 포함하고, 요약이나 설명은 쓰지 마세요.
- 가능한 한 최신 기사 우선으로 고르고, 필요하면 공공기관·기념관·박물관 자료도 포함할 수 있습니다.
