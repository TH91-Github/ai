...
- 현재 블로그 글 본문에는 "📰 관련기사" 섹션을 추가해 주세요.
...
- 이 주제와 직접 관련된 국내(한국) 건강/생활정보 뉴스 기사 3개 이상을 선별해 주세요.
...
- 적절한 관련 기사가 전혀 없으면 이 섹션은 생략해 주세요.
...
- 위치는 본문 마지막, 마지막 소제목 이후 마무리 문단 바로 다음입니다.
- 형식은 반드시 <ul> 안에 <li><a href="URL" target="_blank" rel="noopener noreferrer">기사 제목</a></li> 구조를 사용해 주세요.
- 이 사건과 직접 관련된 국내(한국) 기사 또는 국내 기관 참고 자료 3개 이상을 선별해 주세요.
- 제목과 링크만 포함하고, 요약이나 설명은 쓰지 마세요.
- 최신 기사보다 공공기관, 박물관, 기념관, 국가기록원, 역사기관 자료를 우선해 주세요.
- 국내 자료가 부족한 세계사 사건은 Britannica처럼 신뢰 가능한 역사기관 자료를 보조로 사용할 수 있습니다.
- 출처가 불명확한 블로그 링크, 개인 글, 검증되지 않은 매체는 사용하지 마세요.
- 적절한 관련 기사나 자료가 전혀 없으면 이 섹션은 생략해 주세요.
