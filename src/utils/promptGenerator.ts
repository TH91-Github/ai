...
- 본문 흐름 속 이미지 포함
- 마지막 요약 섹션도 고정 이름을 쓰지 말고, "짧게 정리하면", "한 번에 정리", "이 흐름만 기억하면 됩니다", "핵심만 빠르게 보면", "정리해보면" 같은 자연스러운 표현으로 매번 다르게 변형해 주세요.
...
- 소제목에도 흐름을 돕는 이모지를 가볍게 사용할 수 있지만, 제목 자체가 템플릿처럼 보이지 않게 해 주세요.
